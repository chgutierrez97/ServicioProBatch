...
public class Archivo {
	...
	public String toString() {
		return "Archivo [idArchivo=" + idArchivo + ", usuarioDominioArchivo=" + usuarioDominioArchivo + ", usuarioArchivo=" + usuarioArchivo + ", claveArchivo="
				+ claveArchivo + ", permisoArchivo=" + permisoArchivo + ", pathArchivo=" + pathArchivo + ", nombreArchivo=" + nombreArchivo
				+ ", dominioArchivo=" + dominioArchivo + "]";
	}
