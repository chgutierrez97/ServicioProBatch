...
public class Directorio {
	...
	public static Logger logger = LoggerFactory.getLogger(Directorio.class);
	...
	public String toString() {
		return "Directorio [idDirectorio=" + idDirectorio + ", pathDirectorio=" + pathDirectorio + ", pathDirMostrar=" + pathDirMostrar
				+ ", usuarioDominioDirectorio=" + usuarioDominioDirectorio + ", usuarioDirectorio=" + usuarioDirectorio + ", claveDirectorio=" + claveDirectorio
				+ ", permisoDirectorio=" + permisoDirectorio + ", dominioDirectorio=" + dominioDirectorio + ", archivos=" + archivos + "]";
	}
}
