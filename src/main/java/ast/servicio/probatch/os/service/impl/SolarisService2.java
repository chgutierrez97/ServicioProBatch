...
public class SolarisService2  extends LinuxService {

	public static Logger logger = LoggerFactory.getLogger(SolarisService.class);

	public SolarisService2() {}

	public String[] getExecuteCommand(ParametrosProceso parametroP) {
		StringBuilder cmdString = new StringBuilder();

		// su - user -c 'cd $DIR;
		cmdString.append(String.format("pfexec  - %s -c 'cd %s; ", parametroP.getUsuario().getNombre(), parametroP.getChdir()));
